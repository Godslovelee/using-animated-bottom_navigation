//modification of the existing bottom_navigation library;
...
class XBottomNavigation extends StatefulWidget {
  XBottomNavigation(
      {@required this.tabs,
...
class FancyBottomNavigationState extends State<XBottomNavigation>
